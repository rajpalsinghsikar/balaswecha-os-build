...
apt-get update
apt-get upgrade
apt-get install nodejs nodejs-legacy apache2 libapache2-mod-php5
libapache2-mod-python openjdk-7-jre pepperflashplugin-nonfree
update-pepperflashplugin-nonfree --install
apt-get install -y celestia geogebra kgeography kalzium kbruch stellarium step
tuxmath openshot audacity chromium-browser openteacher khangman
